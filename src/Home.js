...
<div class="team">
    <h3>Our team</h3>
    <p>Welcome to our website, we hope you enjoy while browsing our website. First, let's introduce our group and members: Nigar Salayeva, Laman Khudadatzade, Surkhay Fatullayev. It's our first project as a group and the project is about movies. When scrolling down first you will get information about our group members and then about our projects. Have fun!
</p>
<h3>Team Members</h3>
<div class="member">
    <div class="nude">
...
<ul>
    <li>
      ...
      <p> Our first project is to create our own website and digital-card. We had to create the website using all the CSS we had learned. Also, we had to add  a link to our Github account, a  link to our Github page, and a link to the personal digital card in our navigation bar. Links are placed under each member's information box.</p>
    </li>
    <li>
      <h2>Weather App</h2>
